...
public class UriTemplateSuiteTest {
    ...
    public void test() throws Exception {
        ...
        final String result;
        try {
            final UriTemplateCompiler compiler = new UriTemplateCompiler();
            compiler.config().setAllowMissingVarsInMap(true);
            result = compiler.process(testcase.template, Vars.wrap(testcase.variables));
            if (expectException) {
